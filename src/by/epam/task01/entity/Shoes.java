...
public class Shoes extends MainEquip { //мотообувь
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.baseMaterial);
    ...
    public void setBaseMaterial(String baseMaterial) throws ProjectException {
        if (baseMaterial == null) {
            throw new ProjectException("Shoes.baseMaterial == null");
        }
        if (baseMaterial.isEmpty()) {
            throw new ProjectException("Shoes.baseMaterial is empty");
        }
