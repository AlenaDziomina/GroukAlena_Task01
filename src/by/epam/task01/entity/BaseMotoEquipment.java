...
public abstract class BaseMotoEquipment extends MotoEquipment{ //основной экип
    ...
    public void setSize(String size) throws ProjectException{
        if (size == null) {
            throw new ProjectException("BaseMotoEquipment.size == null");
        }
        if (size.isEmpty()) {
            throw new ProjectException("BaseMotoEquipment.size is empty");
        }
        this.size = size;
    }
    ...
    public void setGender(String gender) throws ProjectException{
        if (gender == null) {
            throw new ProjectException("BaseMotoEquipment.gender == null");
        }
