...
public abstract class BodyProtection extends MainEquip{ //защита тела
    ...
    public int hashCode() {
        int hash = 5;
        hash = 97 * hash + Objects.hashCode(this.protectionMaterial);
        return hash;
    }
    ...
    public void setProtectionMaterial(String protectionMaterial)
        ...
        if (protectionMaterial == null) {
            throw new ProjectException("BodyProtection.protectionMaterial == null");
        }
        if (protectionMaterial.isEmpty()) {
            throw new ProjectException("BodyProtection.protectionMaterial is empty");
        }
